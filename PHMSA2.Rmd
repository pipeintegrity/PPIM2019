...
```{r,echo=FALSE,message=FALSE, warning=FALSE,results="hide", include=TRUE, fig.cap="Figure 13: Leak Rates in HCAs Compared to all Transmission Pipe", fig.width=5, fig.height=3, dpi=300}
...
plotPost(best_lk_hca_nhca$mu1/best_lk_hca_nhca$mu2, compVal = 1, 
         ...
         cex.lab = 1.75, main = "Ratio of Annual Leaks/1,000 Miles")
```
