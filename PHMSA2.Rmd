...
The HDI for the ratio of fatailties is approximately centered on one, indicating that there is evidence of no change in the rate for fatilites after the IM rule.  Even though the HDI for fatalities extends far past one in both directions it is not surprising given the typical annual rate is about two and a change in count of one in either direction in a given year is a 50% swing.  Therefore in the case of fatalities it would be reasonable to accept the null hypothesis that the rate is unchanged. 
  
The HDI of Injury rates comes almost right up to the threshold of one at 0.99 which for practical purposes is equivalent to one. Therefore, based on the range of uncertainty for injuries we can't say that there has been a change in the annual rate. However with 98% of the distribution less than one and the most credible value at about 0.80 we can say that evidence is pointing in the direction of a reduction in the annual rate of injuries but we cannot make a conclusive statement at this time.  The best we can say in this case is that judgement is withheld as of now.  It could be argued that if the large outlier in injuries from the 2010 San Bruno incident were excluded, the rate almost certainly would show a decrease.  While that staement is true, discarding outliers simply because they don't fit a trend is skewing the results to get a desired outcome.  
