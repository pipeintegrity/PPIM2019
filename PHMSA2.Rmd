...
flr=ggplot(HCA)+geom_col(aes(year,flr_mile*1000),fill='firebrick',col='black')+
  theme_bw()+scale_x_continuous(breaks = c(seq(2004,2017,by=2)))+
...
sig=ggplot(HCA)+geom_col(aes(year, sig/miles*1000),fill='cornflowerblue',col='black')+theme_bw()+scale_x_continuous(breaks = c(seq(2004,2017, by=2)))+labs(title="HCA Significant Incidents per 1,000 Miles",y="Significant Incident Rate",x="Year")+
  theme(title = element_text(size=rel(0.8)),axis.text = element_text(size=rel(0.8)))
